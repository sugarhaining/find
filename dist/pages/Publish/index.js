...
var Publish = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Publish() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Publish.__proto__ || Object.getPrototypeOf(Publish)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return Publish;
}(_taroWeapp2.default.Component), _class.$$events = [], _class.$$componentPath = "pages/Publish/index", _temp2);
...
},[["./src/pages/Publish/index.tsx","runtime","vendors"]]]);