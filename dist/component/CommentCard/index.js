...
var CommetnCard = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(CommetnCard, [{
    ...
    value: function _createData() {
      ...
      ;
      var comment = this.__props.comment;
      ...
      var anonymousState__temp5 = cx('content');
      var anonymousState__temp6 = cx('time');
      var anonymousState__temp7 = cx('hr');
      var $anonymousCallee__1 = new Array(3).fill('');
      var loopArray13 = replyMessage.map(function (msg, _anonIdx3) {
        msg = {
          $original: (0, _taroWeapp.internal_get_original)(msg)
        };
        var $loopState__temp9 = cx('reply');
        return {
  ...
  return CommetnCard;
}(_taroWeapp2.default.Component), _class.$$events = [], _class.$$componentPath = "component/CommentCard/index", _temp2);
...
},[["./src/component/CommentCard/index.tsx","runtime","vendors"]]]);